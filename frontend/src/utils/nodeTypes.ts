...
export const NODE_TYPE_META: Record<NodeTypeValue, {
  ...
  [NODE_TYPES.MODEL_SCORE]:   { icon: Brain,              color: "#8b5cf6", label: "SCORING" },
  ...
  [NODE_TYPES.OUTPUT]:        { icon: CircleDot,          color: "#f43f5e", label: "API OUTPUT" },
  [NODE_TYPES.DATA_SINK]:     { icon: HardDriveDownload,  color: "#f59e0b", label: "SINK" },
  [NODE_TYPES.EXTERNAL_FILE]: { icon: FileArchive,        color: "#ec4899", label: "LOAD FILE" },
  ...
  [NODE_TYPES.OPTIMISER]:         { icon: Target,             color: "#f97316", label: "OPTIMISATION" },
  ...
  [NODE_TYPES.CONSTANT]:          { icon: Hash,               color: "#64748b", label: "CONSTANT" },
