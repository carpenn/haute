...
export const NODE_TYPE_META: Record<NodeTypeValue, {
  ...
  [NODE_TYPES.BANDING]:            { icon: SlidersHorizontal,  color: "#22d3ee", label: "BANDING",        name: "Banding",              description: "Group numerical or categorical values into bands",             defaultConfig: { factors: [{ banding: "continuous", column: "", outputColumn: "", rules: [], default: null }] } },
  [NODE_TYPES.SCENARIO_EXPANDER]:  { icon: Rows3,              color: "#2dd4bf", label: "EXPANDER",       name: "Expander",             description: "Cross-join rows with scenario values (price, tier, etc.)",    defaultConfig: { quote_id: "quote_id", column_name: "scenario_value", min_value: 0.8, max_value: 1.2, steps: 21, step_column: "scenario_index" } },
  [NODE_TYPES.RATING_STEP]:        { icon: TableProperties,    color: "#14b8a6", label: "RATING",         name: "Rating Step",          description: "Lookup, factor, cap/floor",                                   defaultConfig: { tables: [{ name: "Table 1", factors: [], outputColumn: "", defaultValue: "1.0", entries: [] }], operation: "multiply", combinedColumn: "" } },
  // Model group (violet) — ML training & scoring
  [NODE_TYPES.MODELLING]:          { icon: FlaskConical,       color: "#8b5cf6", label: "TRAINING",       name: "Model Training",       description: "Train and evaluate a CatBoost model",                         defaultConfig: {} },
  [NODE_TYPES.MODEL_SCORE]:        { icon: Brain,              color: "#8b5cf6", label: "SCORING",        name: "Model Scoring",        description: "Score using an MLflow model",                                 defaultConfig: { sourceType: "registered", registered_model: "", version: "latest", task: "regression", output_column: "prediction", code: "" } },
