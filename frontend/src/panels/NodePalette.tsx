  ...
  return (
    <div className="w-[180px] h-full overflow-y-auto shrink-0 flex flex-col" style={{ background: "var(--chrome)", borderRight: "1px solid var(--chrome-border)" }}>
      <div className="px-4 py-3">
        <h2 className="text-[10px] font-bold uppercase tracking-[0.1em]" style={{ color: "var(--text-muted)" }}>Nodes</h2>
      </div>
        ...
        {nodeTemplates.map((template) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[12px] font-medium" style={{ color: "var(--text-primary)" }}>{template.label}</span>
            </div>
          )
        })}
      </div>
